class ReasoningConfig:
    ...
    """Default maximum number of thinking tokens per request.

    When set, vLLM applies this as SamplingParams.thinking_token_budget
    for requests that do not specify thinking_token_budget. Requires an
    enabled reasoning configuration (start/end strings or parser defaults).
    """
