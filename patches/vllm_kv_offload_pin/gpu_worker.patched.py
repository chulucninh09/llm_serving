    def __init__(
        ...
        if pin_memory:
            if not current_platform.is_cuda_alike():
                ...
                # Pin synchronously before CUDA graph capture. Background pinning
                # races with graph capture and can invalidate the capture stream.
                logger.info("Pinning CPU offload memory...")
